...
public class FractionCalculator extends javax.swing.JFrame {
  FractionInterface fraction1;
  FractionInterface fraction2;
  ...
  private void jbtAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtAddActionPerformed
    operatorListener.actionPerformed(evt);
  ...
  private class OperatorListener implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e) {
        int numerator1 = Integer.parseInt(jtfNumerator1.getText());
        int denominator1 = Integer.parseInt(jtfDenominator1.getText());
        int numerator2 = Integer.parseInt(jtfNumerator2.getText());
        int denominator2 = Integer.parseInt(jtfDenominator2.getText());
        try{
        ...
        switch (operator){
            case "+":
                fractionResult = (Fraction)fraction1.add(fraction2);
                result = fraction1.toString() + " + " + fraction2.toString() + " = " + fractionResult.toSimplestForm();
                jtfResult.setText(result);
                break;
            case "-":
                fractionResult = (Fraction)fraction1.subtract(fraction2);
                result = fraction1.toString() + " - " + fraction2.toString() + " = " + fractionResult.toSimplestForm();
                jtfResult.setText(result);
                break;
            case "*":
                fractionResult = (Fraction)fraction1.multiply(fraction2);
                result = fraction1.toString() + " * " + fraction2.toString() + " = " + fractionResult.toSimplestForm();
                jtfResult.setText(result);
                break;
            default:
                try{
                    fractionResult = (Fraction)fraction1.divide(fraction2);
                    result = fraction1.toString() + " / " + fraction2.toString() + " = " + fractionResult.toSimplestForm();
                    jtfResult.setText(result);
                }catch (NumberFormatException ex){
                    JOptionPane.showMessageDialog(null, ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
